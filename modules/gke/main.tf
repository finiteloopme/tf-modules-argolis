...
module "gke-subnet"{
  ...
  network                     = var.network
  gke_network                 = var.gke_instance.name
  ip_range_pods               = var.secondary_ranges.pod_ips.name
  svc_ips                     = var.secondary_ranges.svc_ips.name
...
module "gke" {
  ...
  # zones                       = [var.gcp_zone]
  network                     = var.gke_instance.name
  # subnetwork                  = var.subnetwork
  subnetwork                  = module.gke-subnet.subnets["${var.gcp_region}/${var.gke_network.name}"].name
  # subnetwork                  = var.gke_network.name

  ip_range_pods               = var.econdary_ranges.pod_ips.name
  ip_range_services           = var.secondary_ranges.svc_ips.name
